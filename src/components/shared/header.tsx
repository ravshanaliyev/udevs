        ...
        <div className="container py-8 ">
            <div className="w-full flex flex-col md:flex-row justify-center items-center gap-8 h-fit md:h-[600px]">
                <div className="w-full md:w-1/2 flex flex-col items-center md:items-start gap-4">
                    <img data-aos="fade-right" data-aos-duration="1000" className="w-[125px] md:w-[250px] h-fit" src={Logo} alt="Logo" />
                    <h1 data-aos="fade-right" data-aos-duration="1200" className="text-[24px] md:text-[40px] text-[#464359] font-bold">IT-Outsourcing Company</h1>
                    ...
                    <Link data-aos="fade-right" data-aos-duration="1500" className="hidden md:block" to="#contact"><Button className="h-[52px] w-[200px] text-xl font-semibold">Contact </Button></Link>
                </div>
