            ...
            <div className="container">
                ...
                <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-8 md:gap-16">
                    <div className="w-full md:w-1/2 ">
                        <p className="text-base md:text-xl text-[#464359] font-semibold leading-relaxed">For each project, we form a team that includes a project manager, business analyst, UI / UX designer, DevOps, QA engineer, backend and front-end developers.</p>
